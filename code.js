...
const controlBtns = [".result", ".plus", ".minus", ".multiply", ".divide", ".pow", ".multiInvers", ".squareRoot", ".percent", ".clearAll", ".clear", ".backspace", ".negative"];
const controlFn = [result, add, substract, multiply, divide, power, multiInvers, squareRoot, percent, deleteAll, deleteAll, backspace, addNegative];
...
function addNegative() {
  if (final.innerHTML !== "0" && final.innerHTML !== "0." && final.innerHTML !== "") {
...
document.querySelector(".alert1 .close > span").addEventListener("click", () => {
...
document.querySelector(".alert2 .close > span").addEventListener("click", () => {
  document.querySelector(".alert2").classList.remove("pop")
})

document.querySelector(".memBtns").addEventListener('click', () => document.querySelector(".alert3").classList.add("pop"))
document.querySelector(".alert3 .close > span").addEventListener("click", () => {
